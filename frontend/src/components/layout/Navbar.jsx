        ...
        <div className={`${isDarkMode ? 'bg-slate-900 text-white' : 'bg-white text-gray-900'} fixed w-full z-10 top-0`}>
            <nav className="flex items-center justify-between px-6 py-4 shadow-md">
                ...
                <div className="flex items-center gap-6 w-full justify-center">
                    ...
                    <Button type="link" className={`text-lg font-extrabold ${isDarkMode ? 'text-white' : 'text-gray-900'} hover:text-yellow-500 transition-all duration-300`} onClick={() => handleNavigate("/soporte")}>
